...
public class HeavenSmiteProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == ProjetlibresecModItems.DELETED_MOD_ELEMENT.get()) {
					...
					for (Entity entityiterator : _entfound) {
						if (!(entityiterator == entity)) {
							...
							if (new Object() {
								...
								} else if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == ProjetlibresecModItems.DELETED_MOD_ELEMENT.get()) {
									if (world instanceof ServerLevel _level) {
										(entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).hurtAndBreak(5, _level, null, _stkprov -> {
										});
									}
